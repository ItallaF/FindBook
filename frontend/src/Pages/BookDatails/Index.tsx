    ...
    <Container>
      ...
      <section className='gap-4 grid grid-cols-1 md:grid-cols-2 mt-16'>
        <div>
          ...
          <p className='text-xl text-evergrayLight font-light py-4'>Autor</p>
          <p className='text-evergrayLight mt-6'> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec
            ...
            arcu. In odio erat, blandit vitae metus nec, fermentum porta lectus.</p>
        </div>
        <div>
          <img
